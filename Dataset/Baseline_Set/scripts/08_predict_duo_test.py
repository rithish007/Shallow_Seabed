"""Run all trained models on the DUO test set (input_images/DUO/) -- a third- party underwater object detection benchmark (Roboflow-style export, flat folder of .jpg photos), not generated by the UE simulation and not one of this project's own real-photo test set (input_images/real_test_images/)."""
import os
